...
/**
 * Class TB_Visibility_Expression_Equals
 *
 * An equals ( == ) compare expression.
 */
class TB_Visibility_Expression_Equals extends TB_Visibility_Expression
{
    /**
    ...
    {
        return 'equals:' . $this->getLeft()->getNotation($context) . $this->getRight()->getNotation($context);
    }
