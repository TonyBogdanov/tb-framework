...
/**
 * Class TB_Visibility_Expression_And
 *
 * An and ( && ) compare expression.
 */
class TB_Visibility_Expression_And extends TB_Visibility_Expression
{
    /**
    ...
    {
        return 'and:' . $this->getLeft()->getNotation($context) . $this->getRight()->getNotation($context);
    }
